...
mixin _$MapState {
  ...
  dynamic get itemList => throw _privateConstructorUsedError;
  ...
  $Res call({
    ...
    return _then(_$_MapState(
      ...
      position: null == position
          ...
          : position // ignore: cast_nullable_to_non_nullable
              as Position,
      itemList: freezed == itemList ? _value.itemList! : itemList,
    ));
  }
}
...
class _$_MapState implements _MapState {
  ...
  @override
  String toString() {
    return 'MapState(isLoading: $isLoading, errorMessage: $errorMessage, position: $position, itemList: $itemList)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, isLoading, errorMessage,
      position, const DeepCollectionEquality().hash(itemList));
...
abstract class _MapState implements MapState {
  const factory _MapState(
      ...
      final dynamic itemList}) = _$_MapState;
