...
class _$_ItemModel with DiagnosticableTreeMixin implements _ItemModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'ItemModel(id: $id, title: $title, createdAt: $createdAt, latitude: $latitude, longitude: $longitude, scope: $scope, description: $description, radius: $radius, userId: $userId, file: $file)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, title, createdAt, latitude,
      longitude, scope, description, radius, userId, file);
...
abstract class _ItemModel implements ItemModel {
  const factory _ItemModel(
      ...
      final int radius,
      final String userId,
      required final FileModel file}) = _$_ItemModel;
